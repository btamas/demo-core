(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["logger/console"] = factory(require("lodash"));
	else
		root["logger/console"] = factory(root["lodash"]);
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/logger/console.js");
/******/ })
/************************************************************************/
/******/ ({
 ...
 */
    ...
    /* harmony default export */ __webpack_exports__["default"] = ({
        setConfig : function setConfig(newConfig){
            config = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.defaults(newConfig || {}, config);
        },
        log : function log(record){
            var level = record.level;
            if (this.checkMinLevel(config.level, level)) {
                if(lodash__WEBPACK_IMPORTED_MODULE_0___default.a.isFunction(window.console[mapping[level]])){
                    if(record.err){
